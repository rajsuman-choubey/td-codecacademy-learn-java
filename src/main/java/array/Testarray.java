...
public class Testarray {
  ...
  public Testarray(String[] initialArticles, int[] initialViews, double[] initialRatings){
  ...
  public static void main(String[] args){
    ...
    Testarray robotTimes = new Testarray(robotArticles, robotViewers, robotRatings);
